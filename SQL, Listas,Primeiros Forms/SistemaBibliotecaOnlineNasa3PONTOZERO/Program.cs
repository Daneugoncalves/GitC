    ...
    class Program
    {
        ...
        public static bool? PesquisaLivroParaAlocacao(ref string nomeLivro)
        {
            for (int i = 0; i < baseDeLivros.GetLength(0); i++)
            {
               ...
               Console.WriteLine("Nehum Livro encontrado, deseja realizar a busca novamente?");
               ...
               if (opcao == 1)
                {
                    ...
                    return PesquisaLivroParaAlocacao(ref nomeLivro); // casa 134
                }


            }

            return null; // se ele nao encontrar o livro ele retorna vazio
        }
        /// <summary> 
        ...
        public static void DesalocarUmLivro()
        {
            ...
            // OS DOIS TEM QUE ESTR CERTO SE RESULTADO DA PESQUISA FOR DIFERENTE DE NULL E PESQUISA 
            if (resultadoPesquisa != null 
