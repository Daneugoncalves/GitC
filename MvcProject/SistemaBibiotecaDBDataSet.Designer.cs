...
namespace MvcProject {
    ...
    public partial class SistemaBibiotecaDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AutoresDataTable : global::System.Data.TypedTableBase<AutoresRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AutoresRow AddAutoresRow(string Nome, string Descricao, string DeletColum) {
        ...
        public partial class AutoresRow : global::System.Data.DataRow {
            ...
            public string DeletColum {
                get {
                    try {
                        return ((string)(this[this.tableAutores.DeletColumColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'DeletColum\' in table \'Autores\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAutores.DeletColumColumn] = value;
                }
            }
            ...
            public bool IsDeletColumNull() {
                return this.IsNull(this.tableAutores.DeletColumColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDeletColumNull() {
                this[this.tableAutores.DeletColumColumn] = global::System.Convert.DBNull;
            }
...
SELECT Id, Nome, Descricao FROM Autores WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "UPDATE [dbo].[Autores] SET [Nome] = @Nome, [Descricao] = @Descricao FROM Autores " +
                "WHERE (Id = @Id)";
        ...
        public virtual int UpdateQuery(string Nome, string Descricao, int Id) {
...
SELECT Id, Registro, Titulo, Isbn, Genero, Editora, Sinopse, Observações, Ativo, UsuInc, UsuAlt, DataInc, DataAlt FROM Livros WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Registro, Titulo, Isbn, Genero, Editora, Sinopse, Observações, Ativo, " +
                "UsuInc, UsuAlt, DataInc, DataAlt FROM dbo.Livros";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
...
SELECT Id, Nome, Login, Senha, Email, Ativo, UsuInc, UsuAlt, DatInc, DatAlt FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE [dbo].[Usuarios] SET [Nome] = @Nome, [Login] = @Login, [Senha] = @Senha, [" +
